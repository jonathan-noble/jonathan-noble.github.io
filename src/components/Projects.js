...
const projects = [
  ...
  },
  {
    ...
    videoId: "_XfzyrmcO_c",
    desc:
      'A survival Virtual Reality game where the player must complete the objectives within a span of resource.',
  ...
  },
  {
    ...
    // videoId: "",
    desc:
      'A web app that lets users log in with their registered account and create a logbook of their favourite recipes.',
